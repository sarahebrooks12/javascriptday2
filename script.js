...
// while(counter <= 100){
//     console.log(counter, "TWEET TWEET")
//     counter = counter +1;
// }
// for(var i = 0; i <= 100; i++){
...
//     console.log(`Our ancestor: ${cohortOneStudents[i]}`, i)
// }
...
// var interest = ["reading", "playing with my babies", "writing", "planning", "baking"];
// console.log(interest.length)
// for(var i = 0; i < interest.length; i++)
//     if(interest[i] === "reading" ){
//         console.log("My absolute favorite interest is reading")
//     } else {
